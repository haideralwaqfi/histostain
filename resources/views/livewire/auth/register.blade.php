<div>
    <h2 class="mb-6 text-center text-xl font-semibold text-ink">Create account</h2>
    ...
    <form wire:submit="register" class="space-y-4" novalidate>
        <div>
            ...
            <input
                ...
                type="text"
                autocomplete="name"
                class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3 text-sm text-ink shadow-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary @error('name') border-red-400 @enderror"
        ...
        <div>
            <label for="email" class="block text-sm font-medium text-ink">Work email</label>
            <input
                wire:model="email"
                id="email"
                type="email"
                autocomplete="email"
                class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3 text-sm text-ink shadow-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary @error('email') border-red-400 @enderror"
        ...
        <div>
            ...
            <input
                ...
                class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3 text-sm text-ink shadow-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary @error('password') border-red-400 @enderror"
    ...
    <p class="mt-6 text-center text-sm text-ink-muted">
        ...
        <a href="{{ route('login') }}" wire:navigate class="font-medium text-primary hover:underline">Sign in</a>
    </p>
</div>
