    ...
    <div class="px-4 py-5 space-y-5">
        ...
        <div class="space-y-2">
            @forelse($options as $i => $option)
                <div class="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2.5">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        @else
                            ...
                            <span class="ml-2 text-[10px] font-mono text-ink-muted bg-gray-100 rounded px-1.5 py-0.5">{{ $option->key }}</span>
                        @endif
                    </div>
        ...
        <div class="rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-4 space-y-3">
            ...
            <div class="flex gap-2">
                <div class="flex-1">
                    <input
                        ...
                        type="text"
                        placeholder="{{ $tab === 'ihc' ? 'e.g. CD10, Ki-67, HER2' : 'e.g. Oil Red O, Alizarin Red' }}"
            ...
            <p class="text-xs text-ink-muted">
                A unique key will be auto-generated from the label and used when storing requests.
            </p>
        </div>

        {{-- Info note --}}
        <div class="rounded-xl bg-blue-50 border border-blue-100 px-4 py-3 text-xs text-blue-700 leading-relaxed">
            Changes take effect immediately for new requests. Existing requests retain the labels they were submitted with.
        </div>
